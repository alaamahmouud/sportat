...
@push('style')
    ...
    <link rel="stylesheet" href="{{asset('front/css/moreales.css')}}">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 ">
                    <form method="get" action="{{url(route('front.home'))}}">
                        ...
                        <div class="search">
                            <input class="form-control me-2"
                                   autocomplete="off"
                                   id="search" name="search" type="text" placeholder="ابحث" aria-label="Search">
                ...
                <section id="hideElement" style="max-width: 100% ;display: flex">
                    <div class="container">
                        <div class="col-md-10 firstContainer" max-width="10%">
                            <div class="row">

                                @forelse($bestSeller as $seller)
                                    <div class="card wow bounceInDown" data-wow-duration="2s" data-wow-delay="3s" style="width: 13rem;">
...
@push('script')
    ...
    <script>
        function favourites(itemid, userid) {
            var user_id = userid;
            var item_id = itemid;
            $.ajax({
                type: 'post',
