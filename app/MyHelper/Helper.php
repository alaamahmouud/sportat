...
class Helper
{
    ...
    static function notifyByFirebase($title, $body, $tokens, $data = [])        // paramete 5 =>>>> $type
    {
        ...
        $headers = array(
            'Authorization: key=AAAA8OHXDbE:APA91bE-_WjttixMhBp-TeWIJtZ-kC5yHDWM7Q6bqNueP62aquek1lIUxbkbg4SD1IhhnApkvsg1deR-JQVtg1Q4pGvTLHwC3jen5bZvQI22SLVPTyZ7wADgNcfTz1ROrlgztPIuvlum',
